...
module.exports = {
    harvester: {
        ...
        memory: {type: "harvester", home: "", tiredCount: 0, deployTime: 0, state: 0},
    ...
    transporter: {
        ...
        extend: false, // whether the parts list should be looped. Recommended: false
        memory: {type: "transporter", home: "", tiredCount: 0, deployTime: 0, role: "", state: 0},
    ...
    upgrader: {
        ...
        extend: false, // whether the parts list should be looped. Recommended: false
        memory: {type: "upgrader", home: "", tiredCount: 0, deployTime: 0, state: 0},
    ...
    builder: {
        ...
        parts: [MOVE,WORK,CARRY,MOVE,WORK,CARRY,MOVE,WORK,CARRY,MOVE,WORK,CARRY,MOVE,WORK,CARRY,MOVE,WORK,CARRY,],
        extend: false, // whether the parts list should be looped. Recommended: false
        memory: {type: "builder", home: "", tiredCount: 0, deployTime: 0, role: "", state: 0},
        priority: 3, // priority is a number from 0 to 9 where 0 is highest priority
    },
    repairer: {
        ...
        extend: false, // whether the parts list should be looped. Recommended: false
        memory: {type: "repairer", home: "", tiredCount: 0, deployTime: 0, role: "", state: 0},
        priority: 3, // priority is a number from 0 to 9 where 0 is highest priority
    },
};