...
module.exports = {
    E46S62: {
        ...
        stealercount: [1,2],
        abroadworkerpaths: [["E46S62", "E45S62"]],
        abroadworkercount: [2],
    ...
    E46S63: {
        ...
        stealercount: [3],
        abroadworkerpaths: [["E46S62", "E46S61"],["E46S62", "E47S62"]],
        abroadworkercount: [0,0],
    ...
    E45S62: {
        spawners: ["Spawn3"],
        towers: ["5846af56687fb17c3b289c84", "58495552ed772d5d6a8c3e8f"],
        stealerpaths: [["E45S62", "E46S62"]],
        stealercount: [1],
        abroadworkerpaths: [["E45S62", "E45S61"]],
        abroadworkercount: [1,0],
        remotemining: [["E46S63", "E47S63"]],
        reservepaths: [["E45S62", "E45S61"]],
        creeps: {
            harvester: 2,
            spawnfiller: 2,
            worker: 3,
